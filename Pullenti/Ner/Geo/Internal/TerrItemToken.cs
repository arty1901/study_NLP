    ...
    public class TerrItemToken : Pullenti.Ner.MetaToken
    {
        ...
        internal static void PrepareAllData(Pullenti.Ner.Token t0)
        {
            ...
            for (Pullenti.Ner.Token t = t0; t != null; t = t.Next) 
            {
                ...
                TerrItemToken ter = TryParse(t, null);
                if (ter != null) 
                {
                    if (d == null) 
            ...
            for (Pullenti.Ner.Token t = t0; t != null; t = t.Next) 
            {
                ...
                TerrItemToken ter = TryParse(tt, d.Terr);
                if (ter == null) 
                    continue;
                if (dd == null) 
        ...
        public static TerrItemToken TryParse(Pullenti.Ner.Token t, TerrItemToken prev = null)
        {
            if (t == null) 
                return null;
            ...
            if (d != null && d.NoGeo) 
                return null;
            if ((ad != null && SpeedRegime && ((ad.TRegime || ad.AllRegime))) && ((t.LengthChar != 2 || !t.Chars.IsAllUpper))) 
            {
                if (d != null) 
                    return d.Terr;
                if (t.Tag == null) 
            ...
            TerrItemToken res = _TryParse(t, prev);
            if (ad != null) 
                ad.TLevel--;
            if (res == null) 
            {
                    ...
                    if (((term == "РБ" || term == "РК" || term == "TC") || term == "ТС" || term == "РТ") || term == "УР" || term == "РД") 
                    {
                        ...
                        if ((t.WhitespacesBeforeCount < 2) && (t.Previous is Pullenti.Ner.TextToken)) 
                        {
                            ...
                            if (!ok) 
                            {
                                ...
                                {
                                    OrgItemToken org = OrgItemToken.TryParse(tt);
                                    if (org != null) 
                                    {
                                        ok = true;
                                        break;
            ...
            {
                CityItemToken cit = CityItemToken.TryParse(res.BeginToken, null, false);
                if (cit != null) 
                {
            ...
            {
                if (res.TerminItem.CanonicText == "МУНИЦИПАЛЬНЫЙ ОКРУГ" && (res.WhitespacesAfterCount < 3)) 
                {
                    CityItemToken next = CityItemToken.TryParse(res.EndToken.Next, null, false);
                    if (next != null && next.Typ == CityItemToken.ItemType.Noun) 
                    {
                        res.EndToken = next.EndToken;
                        res.AdditionalTyp = next.Value;
                    }
                }
        ...
        static TerrItemToken _TryParse(Pullenti.Ner.Token t, TerrItemToken prev)
        {
            if (!(t is Pullenti.Ner.TextToken)) 
                return null;
                        ...
                        if (nt.EndToken.Next == null || !nt.EndToken.Next.IsHiphen || !(nt.Termin as TerrTermin).IsAdjective) 
                        {
                            ...
                            if (!res1.IsAdjective) 
                            {
                                if (res1.TerminItem.CanonicText == "РЕСПУБЛИКА" || res1.TerminItem.CanonicText == "ШТАТ") 
                                {
                                    ...
                                    {
                                        TerrItemToken res2 = TryParse(res1.EndToken.Next, null);
            ...
            if (t0.Next != null && t0.Next.IsHiphen && (t0.Next.Next is Pullenti.Ner.TextToken)) 
            {
                ...
                {
                    TerrItemToken tit = _TryParse(tt, prev);
                    if (tit != null) 
                    {
            ...
            if (tt.Morph.Class.IsAdverb) 
                return null;
            CityItemToken cit = CityItemToken.TryParse(t0, null, false);
            if (cit != null) 
            {
            ...
            if (npt != null && npt.EndToken != npt.BeginToken) 
            {
                ...
                else 
                {
                    ...
                    {
                        TerrItemToken next = TryParse(npt.EndToken, null);
                        ...
                        {
                            CityItemToken cit1 = CityItemToken.TryParse(npt.EndToken, null, false);
            ...
            if (npt != null && npt.EndToken == tt.Next) 
            {
                ...
                if (regAfter) 
                {
                    ...
                    if (!adj) 
                    {
                        CityItemToken cit1 = CityItemToken.TryParse(tt.Next.Next, null, false);
        ...
        static TerrItemToken _tryParseDistrictName(Pullenti.Ner.Token t, int lev = 0)
        {
            ...
            if ((t.Next is Pullenti.Ner.TextToken) && t.Next.Chars.Equals(t.Chars)) 
            {
                ...
                if (npt != null && npt.EndToken == t.Next && npt.Adjectives.Count == 1) 
                {
                    ...
                    {
                        TerrItemToken ty = _TryParse(t.Next, null);
        ...
        public static List<TerrItemToken> TryParseList(Pullenti.Ner.Token t, int maxCount)
        {
            TerrItemToken ci = TerrItemToken.TryParse(t, null);
            if (ci == null) 
                return null;
            ...
            for (t = ci.EndToken.Next; t != null; ) 
            {
                ...
                if (ci == null) 
                {
                    ...
                    {
                        CityItemToken cit = CityItemToken.TryParse(t.Next, null, false);
                    ...
                    {
                        ci = TerrItemToken.TryParse(t.Next, null);
                    ...
                    {
                        List<TerrItemToken> li2 = TryParseList(t.Next, 2);
                    ...
                    {
                        List<TerrItemToken> lii = TryParseList(t.Next, maxCount);
        ...
        public static void Initialize()
        {
            ...
            t.AddVariant("В ГРАНИЦАХ ЗЕМЛИ", false);
            t.AddVariant("В ГРАНИЦАХ БЫВШИХ ЗЕМЕЛЬ", false);
            t.AddVariant("В ГРАНИЦАХ БЫВШ. ЗЕМЕЛЬ", false);
            m_TerrOntology.Add(t);
