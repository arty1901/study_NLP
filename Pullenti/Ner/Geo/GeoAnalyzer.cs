...
namespace Pullenti.Ner.Geo
{
    ...
    public class GeoAnalyzer : Pullenti.Ner.Analyzer
    {
        ...
        public override void Process(Pullenti.Ner.Core.AnalysisKit kit)
        {
            ...
            ad.TRegime = true;
            Pullenti.Ner.Geo.Internal.CityItemToken.SpeedRegime = false;
            ...
            for (int step = 0; step < 2; step++) 
            {
                ...
                for (Pullenti.Ner.Token t = kit.FirstToken; t != null; t = t.Next) 
                {
                    ...
                    if (ok) 
                        cli = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParseList(t, 5);
                    if (cli == null) 
                        continue;
                    t.InnerBool = true;
                    ...
                    if ((rt == null && cli.Count == 1 && cli[0].IsAdjective) && cli[0].OntoItem != null) 
                    {
                        ...
                        if (tt != null) 
                        {
                            ...
                            List<Pullenti.Ner.Geo.Internal.TerrItemToken> cli1 = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParseList(tt, 2);
                            ...
                            if (rt == null && (cli[0].OntoItem.Referent as GeoReferent).IsState) 
                            {
                                ...
                                if (rt == null && step == 0) 
                                {
                                    ...
                                    {
                                        List<Pullenti.Ner.Geo.Internal.CityItemToken> cits = Pullenti.Ner.Geo.Internal.CityItemToken.TryParseList(tt, 5);
                    ...
                    if (rt == null && cli.Count == 2) 
                    {
                        ...
                        if (li != null && li.Count > 0) 
                        {
                            ...
                            {
                                Pullenti.Ner.Address.Internal.StreetItemToken ad0 = Pullenti.Ner.Address.Internal.StreetItemToken.TryParse(cli[0].BeginToken.Previous, null, false);
                                ...
                                {
                                    Pullenti.Ner.Address.Internal.AddressItemToken aaa = Pullenti.Ner.Address.Internal.AddressItemToken.TryParse(cli[0].BeginToken, false, null);
            ...
            for (Pullenti.Ner.Token t = kit.FirstToken; t != null; t = t.Next) 
            {
                ...
                li = Pullenti.Ner.Geo.Internal.CityItemToken.TryParseList(t, 5);
                ...
                if (!isCityBefore) 
                    continue;
                List<Pullenti.Ner.Geo.Internal.TerrItemToken> tts = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParseList(t, 5);
        ...
        List<Pullenti.Ner.Geo.Internal.CityItemToken> TryParseCityListBack(Pullenti.Ner.Token t)
        {
            ...
            for (Pullenti.Ner.Token tt = t; tt != null; tt = tt.Previous) 
            {
                ...
                List<Pullenti.Ner.Geo.Internal.CityItemToken> ci = Pullenti.Ner.Geo.Internal.CityItemToken.TryParseList(tt, 5);
                if (ci == null && tt.Previous != null) 
                    ci = Pullenti.Ner.Geo.Internal.CityItemToken.TryParseList(tt.Previous, 5);
                if (ci == null) 
                    break;
        ...
        Pullenti.Ner.ReferentToken TryAttachTerritoryBeforeCity(Pullenti.Ner.Token t, Pullenti.Ner.Core.AnalyzerDataWithOntology ad)
        {
            ...
            for (Pullenti.Ner.Token tt = t; tt != null; tt = tt.Previous) 
            {
                ...
                if (i > 10) 
                    break;
                List<Pullenti.Ner.Geo.Internal.TerrItemToken> tits0 = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParseList(tt, 5);
                if (tits0 == null) 
                    continue;
                if (tits0[tits0.Count - 1].EndToken != t) 
                    break;
                List<Pullenti.Ner.Geo.Internal.TerrItemToken> tits1 = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParseList(tt.Previous, 5);
        ...
        Pullenti.Ner.ReferentToken TryAttachTerritoryAfterCity(Pullenti.Ner.Token t, Pullenti.Ner.Core.AnalyzerDataWithOntology ad)
        {
            ...
            for (int i = 0; i < 2; i++) 
            {
                Pullenti.Ner.Geo.Internal.TerrItemToken tit0 = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParse(tt, null);
                if (tit0 == null || tit0.TerminItem != null) 
                {
                    if (i == 0) 
                        return null;
                }
                Pullenti.Ner.Geo.Internal.CityItemToken cit0 = Pullenti.Ner.Geo.Internal.CityItemToken.TryParse(tt, null, false);
                if (cit0 == null || cit0.Typ == Pullenti.Ner.Geo.Internal.CityItemToken.ItemType.Noun) 
                {
                    if (i == 0) 
                        return null;
                }
                Pullenti.Ner.Address.Internal.AddressItemToken ait0 = Pullenti.Ner.Address.Internal.AddressItemToken.TryParse(tt, false, null);
                if (ait0 != null) 
                    return null;
                if (tit0 == null) 
                {
            ...
            Pullenti.Ner.Address.Internal.AddressItemToken ait = Pullenti.Ner.Address.Internal.AddressItemToken.TryParse(tt, false, null);
            if (ait == null) 
                return null;
        ...
        public override Pullenti.Ner.ReferentToken ProcessReferent(Pullenti.Ner.Token begin, string param)
        {
            ...
            if (!begin.Morph.Class.IsAdjective) 
            {
                ...
                ad.Level++;
                Pullenti.Ner.Geo.Internal.TerrItemToken tt0 = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParse(begin, null);
                ad.Level--;
                if (tt0 != null && tt0.TerminItem != null && tt0.TerminItem.CanonicText == "РАЙОН") 
                {
                    ad.Level++;
                    Pullenti.Ner.Geo.Internal.TerrItemToken tt1 = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParse(tt0.EndToken.Next, null);
                    ad.Level--;
                ...
                ad.Level++;
                List<Pullenti.Ner.Geo.Internal.CityItemToken> ctoks = Pullenti.Ner.Geo.Internal.CityItemToken.TryParseList(begin, 3);
                if (ctoks == null && begin.Morph.Class.IsPreposition) 
                    ctoks = Pullenti.Ner.Geo.Internal.CityItemToken.TryParseList(begin.Next, 3);
                ad.Level--;
                if (ctoks != null) 
                {
            ...
            ad.Level++;
            Pullenti.Ner.Geo.Internal.TerrItemToken tt = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParse(begin, null);
            ad.Level--;
            ...
            {
                ad.Level++;
                List<Pullenti.Ner.Geo.Internal.TerrItemToken> li = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParseList(begin, 3);
                Pullenti.Ner.ReferentToken res = Pullenti.Ner.Geo.Internal.TerrDefineHelper.TryDefine(li, ad, true, null, null);
                ad.Level--;
                if (res == null) 
                    tt.OntoItem = null;
            ...
            if (tt.OntoItem == null) 
            {
                ...
                if (t1 == null) 
                    return res1;
                ad.Level++;
                Pullenti.Ner.Geo.Internal.TerrItemToken ttyp = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParse(t1, null);
                ad.Level--;
                if (ttyp == null || ttyp.TerminItem == null) 
                {
                    ad.Level++;
                    List<Pullenti.Ner.Geo.Internal.CityItemToken> cits = Pullenti.Ner.Geo.Internal.CityItemToken.TryParseList(begin, 2);
                    ad.Level--;
        ...
        {
            List<Pullenti.Ner.Geo.Internal.CityItemToken> li = Pullenti.Ner.Geo.Internal.CityItemToken.TryParseList(begin, 4);
            if (li != null && li.Count > 1 && li[0].Typ == Pullenti.Ner.Geo.Internal.CityItemToken.ItemType.Noun) 
            {
                ...
                for (Pullenti.Ner.Token t = rt.EndToken.Next; t != null; t = t.Next) 
                {
                    ...
                    if (t == null) 
                        break;
                    li = Pullenti.Ner.Geo.Internal.CityItemToken.TryParseList(t, 4);
            ...
            for (Pullenti.Ner.Token t = begin; t != null; t = t.Next) 
            {
                ...
                for (Pullenti.Ner.Token tt = t0; tt != null; tt = tt.Next) 
                {
                    if (tt.IsCharOf(";")) 
                        break;
                    Pullenti.Ner.Geo.Internal.TerrItemToken tit = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParse(tt, null);
