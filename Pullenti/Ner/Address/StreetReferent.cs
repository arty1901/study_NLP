    ...
    public class StreetReferent : Pullenti.Ner.Referent
    {
        ...
        public StreetKind Kind
        {
            get
            {
                ...
                {
                    if (t == "железная дорога") 
                        return StreetKind.Railway;
                    else if (t.Contains("дорога") || t == "шоссе") 
                        return StreetKind.Road;
                    else if (t.Contains("метро")) 
                        return StreetKind.Metro;
                    else if (Pullenti.Ner.Address.Internal.StreetItemToken._isRegion(t)) 
                        return StreetKind.Area;
                }
